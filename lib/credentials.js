...
module.exports = {
    mongo: {
        development: {
            connectionString: 'mongodb://rtchokeuser:aVix1goo1iwee2eighie8paeyaidae@rtchoke-dev.u-strasbg.fr:27017/rtchoke'
            // connectionString: 'mongodb://rtchokeuser:@127.0.0.1:27017/rtchokedb'
        },
        production: {
            connectionString: 'mongodb://rtchokeuser:aVix1goo1iwee2eighie8paeyaidae@rtchoke-dev.u-strasbg.fr:27017/rtchoke'
        }
